    ...
    <div class="main">
      ...
      <div class="box">
          ...
          <ul id="menu">
            ...
            <li  class="active"><a href="admindelete.php">-Employee</a></li>
        ...
        <article id="content">
          <div class="box1">
            <div class="wrapper">
                     ...
                     <div id="frm">
  <form action="demployee.php" method="post" name="roombook4">
    
        <h2 class="bilal" style="color:#b09012; margin-top: 10px;margin-bottom: 10px ">Delete Employee</h2>
