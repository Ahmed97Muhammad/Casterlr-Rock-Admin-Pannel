  ...
  <div class="bg2">
    <div class="main">
      ...
      <div class="box">
          <nav>
          <ul id="menu">
            <li class="active"><a href="adminadd.php">+Manager</a></li>
...
<h2 style='text-align: center; color: black; font-size: 30px'>ADMIN
 ...
 <br>
    ...
    <div id="frm" style="margin-left: -100px">
  <form action="phpadminadd.php" method="post" name="roombook2">
    
        <h2 class="bilal" style="color:#b09012; margin-left: 150px; margin-top: 10px;margin-bottom: 10px ">Add Manager</h2>
      ...
      <table style="margin-left: 240px;margin-right: 150px; margin-top: 10px;margin-bottom: 10px;table-layout: fixed;">
         ...
         <tr>
          ...
          <td>
                Select Manager Type:
                <select  ng-model="myVar" name="dept" required>
                <option value=""> </option>
