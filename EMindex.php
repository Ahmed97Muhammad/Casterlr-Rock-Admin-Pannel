...
<html lang="en">
<head>
<title>Event Manager Pannel</title>
  ...
  <div class="bg2">
    <div class="main">
      ...
      <div class="box">
          <nav>
          <ul id="menu">
            <li class="active"><a href="EMindex.php">Add Employees</a></li>
            <li><a href="EMView.php">View Employees</a></li>
...
<h2 style='text-align: center; color: black; font-size: 30px'>ADMIN PANEL FOR EVENT MANAGER
    <br>
 <br>
    
<div id="frm">
  <form action="addemployee1.php" method="post" name="roombook1">
