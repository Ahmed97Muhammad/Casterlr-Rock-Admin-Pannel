...
<html lang="en">
<head>
<title>Room Manager Panel</title>
  ...
  <div class="bg2">
    <div class="main">
      ...
      <div class="box">
          <nav>
          <ul id="menu">
            <li class="active"><a href="RBindex.php">Add Employees</a></li>
...
<h2 style='text-align: center; color: black; font-size: 30px'>ADMIN PANEL FOR ROOM BOOKING MANAGER
 </h2>
 <br>
 <br>
    
    <div id="frm">
  <form action="addemployee.php" method="post" name="roombook2">
