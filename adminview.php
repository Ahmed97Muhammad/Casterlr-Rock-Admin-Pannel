    ...
    <div class="main">
      ...
      <div class="box">
          ...
          <ul id="menu">
            ...
            <li  class="active"><a href="adminview.php">Employee</a></li>
...
include "Connection.php";
    ...
    person.CNIC , FNAME , LNAME , Address , PhoneNumber , Email , employee.Emp_ID, employee.Department , Salary , DOB , H_Date
     FROM person , employee where person.CNIC = EMPLOYEE.CNIC");
...
<h2 style='text-align: center; color: black; font-size: 30px'>MANAGER DETAILS


 <?php

echo "<table style='border: solid 1px black; font-size:15px; margin-left:320px; '>";
...
include "Connection.php";
    ...
    $stmt = $conn->prepare("SELECT Emp_ID, Department FROM manager");
   ...
   {
        echo "<tr><th>EMP_ID</th><th>Department</th></tr>";
